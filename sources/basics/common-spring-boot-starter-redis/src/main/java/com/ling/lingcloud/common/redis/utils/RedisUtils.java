package com.ling.lingcloud.common.redis.utils;
...
public final class RedisUtils {
     ...
     * @return 是否成功
     */
    public static boolean delCacheList(final String key) {
        return RedisUtils.CLIENT.getList(key).delete();
    }
     ...
     * @return 删除的元素
     */
    public static <T> T delCacheMapKey(
            final String key,
            final String hashKey
    ) {
        final RMap<String, T> map = RedisUtils.CLIENT.getMap(key);
    ...
    public static Boolean isExists(final String key) {
        return RedisUtils.CLIENT.getBucket(key).isExists();
    }
}
